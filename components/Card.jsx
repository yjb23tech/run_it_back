...
const Card = (props) => {
    return (
        <div className="ss-card">
            <div className="ss-row-song-details ss-row-general-setup">
                <h2 className="ss-song-title">{props.song_title}</h2>
                <div className="ss-edit-trash-icons ss-row-general-setup">
                    <img src={pencil_icon} />
                    <img src={trash_icon} />
                </div>
            </div>
            ...
            <div className="ss-row-like-comment-text ss-row-general-setup">
                <p>{props.number_of_likes}</p>
                <p>{props.number_of_comments}</p>
            </div>
            <div className="ss-row-like-comment-icons ss-row-general-setup">
                <img src={heart_icon} />
